...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'projects/project_ws/src/yahboom_rosmaster/yahboom_rosmaster_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'projects/project_ws/install/yahboom_rosmaster_description/share/yahboom_rosmaster_description/config',
        robot_name
    )
